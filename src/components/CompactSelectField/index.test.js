...
it.skip('renders a select field', () => {
  render(
    <SelectField
      name={SELECT_NAME}
...
it.skip('renders a select field with an error', () => {
  render(
    <SelectField
      name={SELECT_NAME}
...
it.skip('renders a select field with no value', () => {
  render(
    <SelectField
      name={SELECT_NAME}
      value={OPTIONS[2].value}
...
it.skip('renders a select field with an error and no value', () => {
  render(
    <SelectField
      name={SELECT_NAME}
      value=''
...
it.skip('select field change event is fired', () => {
  render(
    <SelectField
      name={SELECT_NAME}
      value=''
...
it.skip('select field blur event is fired', () => {
  render(
    <SelectField
      name={SELECT_NAME}
